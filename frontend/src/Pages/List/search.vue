          ...
          <form @submit.prevent="search_function" class="max-w-4xl mx-auto">   
               ...
               <div class="relative">
                    ...
                    <div v-if="loading" role="status">
                         <button  type="button" class="text-white absolute end-2.5 bottom-2.5 bg-primary hover:bg-primary/70 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-6 py-3 dark:bg-primary dark:hover:bg-primary/70 transition dark:focus:ring-primary">
                    ...
                    <button v-else type="submit" class="text-white absolute end-2.5 bottom-2.5 bg-primary hover:bg-primary/70 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-7 py-3 dark:bg-primary dark:hover:bg-primary/70 transition dark:focus:ring-primary">Search</button>
               </div>
          </form>
          <div class="mt-10">
